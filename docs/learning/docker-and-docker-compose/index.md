...
The benefits from using docker include:
...
1. Install docker and docker-compose
   ...
   If you followed [setting up your mac](/docs/techniques/setting-up-your-mac) you should already have docker installed. However, if you do not you can install docker through brew `brew install --cask docker`
...
3. Dockerize the application
   ...
   2. On the top line add `FROM node:18-alpine`
